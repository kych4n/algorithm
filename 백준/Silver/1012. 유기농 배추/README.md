...
### 설계
<p>지렁이가 인접해있는 배추들의 해충을 모두 먹을 수 있으므로, 인접 배추를 탐색하기 위해 BFS를 사용할 수 있다.</p>
<p>배추밭 각 칸을 탐색하면서 배추가 있는 지역이라면, 필요한 지렁이 개수를 늘리고 BFS를 실행하면서, 탐색한 지역은 0으로 바꾼다.</p>
